...
def create_collection():
    def alien_base(position, **kwargs):
        def ai_base(self, engine):
            ...
            # Shoot
        return Enemy(ai_base, "alien_base", position, 1, 4, **kwargs)

    def alien_fly(position, **kwargs):
        def ai_fly(self, engine):
            pass
        return Enemy(ai_base, "alient_fly", position, -1, 6, **kwargs)

    def alien_brain(position, **kwargs):
        def ai_brain(self, engine):
            pass
        return Enemy(ai_base, "alient_brain", position, 5, 10, **kwargs)
